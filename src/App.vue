    ...
    return {
      ...
      products: [
        ...
        },
        {
          ...
          caption: "Just a touch of lavender to elevate this classic flavor combo",
        ...
        {
          img: require("./assets/images/Peach-Hab-Web.png"),
          accentImage: require("./assets/images/SF.svg"),
          accentSide: "left",
          title: "Peach Habanero",
          caption: "Fresh peaches with a hint of heat from habanero",
          ingredients: "Organic cane sugar, Peaches, Habanero",
          nutrition: "",
          color: "#f99c1c",
          bg: "#e04d26",
          accent: "#fbbc99",
